        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="ruc_number">RFC del proveedor</label>
                        <input type="text" class="form-control" name="rfc provider" id="rfc_provider" value="{{$provider->rfc_provider}}" aria-describedby="helpId" required>
                    </div>
